...
class SSLCertificateGenerator:
	...
	def __init__(self, key_dir=None):
		...
		# Get serial number
		try:
			with open(key_dir + '/serial', 'r') as serial_file:
	...
	def _sign_csr(self, req, ca_key, ca_cert, cert_org=False, cert_ou=False, usage=3, days=3650, alt_names=None):
		...
		with open(key_dir + '/index.txt', 'a') as index_file:
	...
	def gen_cert(self, cert_name, cert_org=False, cert_ou=False, usage=3, days=3650, alt_names=None):
